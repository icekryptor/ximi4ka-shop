...
export class AddRemainingEntities1776609054213 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order_id" uuid NOT NULL, "product_id" uuid NOT NULL, "product_snapshot" jsonb NOT NULL, "quantity" integer NOT NULL, "unit_price_rub" integer NOT NULL, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "admin_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "password_hash" character varying(255) NOT NULL, "role" character varying(32) NOT NULL DEFAULT 'editor', "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_06744d221bb6145dc61e5dc441d" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_dcd0c8a4b10af9c986e510b9ec" ON "admin_users" ("email") `,
    )
    await queryRunner.query(
      `CREATE TABLE "entity_revisions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "entity_type" character varying(64) NOT NULL, "entity_id" uuid NOT NULL, "snapshot" jsonb NOT NULL, "edited_by" uuid, "edited_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c4b1255723ea20066b5381878d6" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_3dd7aae2aabe9332d69646eb6d" ON "entity_revisions" ("entity_type", "entity_id") `,
    )
    await queryRunner.query(
      `CREATE TABLE "redirects" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "from_path" character varying(1000) NOT NULL, "to_path" character varying(1000) NOT NULL, "status_code" integer NOT NULL DEFAULT '301', "hit_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_d81f0797728eb0eb92ae3c6eedd" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_294da5325047f1e02da0a0f59c" ON "redirects" ("from_path") `,
    )
    await queryRunner.query(
      `ALTER TABLE "product_categories" ALTER COLUMN "translations" SET DEFAULT '{}'::jsonb`,
    )
    await queryRunner.query(
      `ALTER TABLE "products" ALTER COLUMN "long_description_blocks" SET DEFAULT '[]'::jsonb`,
    )
    await queryRunner.query(
      `ALTER TABLE "products" ALTER COLUMN "translations" SET DEFAULT '{}'::jsonb`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ALTER COLUMN "long_description_blocks" SET DEFAULT '[]'`,
    )
    await queryRunner.query(
      `ALTER TABLE "product_categories" ALTER COLUMN "translations" SET DEFAULT '{}'`,
    )
