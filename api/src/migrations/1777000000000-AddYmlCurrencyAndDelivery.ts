...
export class AddYmlCurrencyAndDelivery1777000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "site_settings" ADD "yml_delivery_note" text`)
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "site_settings" DROP COLUMN "yml_delivery_note"`)
    await queryRunner.query(`ALTER TABLE "site_settings" DROP COLUMN "yml_currency"`)
  }
}
