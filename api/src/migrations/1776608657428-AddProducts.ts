...
export class AddProducts1776608657428 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "product_id" uuid NOT NULL, "url" character varying(500) NOT NULL, "alt" character varying(255) NOT NULL, "sort_order" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_1974264ea7265989af8392f63a1" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product_category_links" ("category_id" uuid NOT NULL, "product_id" uuid NOT NULL, CONSTRAINT "PK_3d552929a0e8dc00e9e99a1577d" PRIMARY KEY ("category_id", "product_id"))`,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_6a244b8fec3db8a3ce4b8c797e" ON "product_category_links" ("category_id") `,
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_a108ea5e3a037ff68cc5081866" ON "product_category_links" ("product_id") `,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_category_links" ADD CONSTRAINT "FK_6a244b8fec3db8a3ce4b8c797e5" FOREIGN KEY ("category_id") REFERENCES "product_categories"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    )
    await queryRunner.query(
      `ALTER TABLE "product_category_links" ADD CONSTRAINT "FK_a108ea5e3a037ff68cc50818665" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "product_category_links" DROP CONSTRAINT "FK_a108ea5e3a037ff68cc50818665"`,
    )
    await queryRunner.query(
      `ALTER TABLE "product_category_links" DROP CONSTRAINT "FK_6a244b8fec3db8a3ce4b8c797e5"`,
    )
    await queryRunner.query(
