...
const pageSeed: Array<{
...
}> = [
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        html: '<p>Добро пожаловать в <strong>Ximi4ka</strong> — магазин наборов для химических и научных экспериментов. У нас вы найдёте всё, чтобы превратить любознательность ребёнка в настоящее открытие.</p>',
      },
      {
        type: 'cta',
        heading: 'Новогодние наборы уже в продаже',
        subtext: 'Соберите удивительный подарок для юного исследователя — скидки до 20% до конца месяца.',
