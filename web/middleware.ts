...
// no locale concept.
const EXCLUDED_PREFIXES = ['/_next', '/api', '/admin', '/fonts', '/uploads', '/amp', '/v3-preview', '/v3-preview-b']
...
export const config = {
  ...
  matcher: [
    '/((?!_next|api|admin|fonts|uploads|amp|v3-preview-b|v3-preview|favicon\\.ico|robots\\.txt|llms\\.txt|sitemap\\.xml|yml\\.xml|turbo\\.xml).*)',
  ],
}
