...
export function CartButton() {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center gap-2.5 rounded-full px-4 py-2.5 sm:px-5 font-[var(--font-lj-mono)] text-[length:var(--text-lj-mono-sm)] font-medium uppercase tracking-[0.08em] text-white bg-[linear-gradient(135deg,#8d67ff_0%,#c856ff_100%)] shadow-[var(--shadow-glow-brand)] transition-transform duration-200 hover:scale-[1.04] active:scale-[0.97] cursor-pointer"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
