...
export function StockChip({ status }: Props) {
  ...
  return (
    <span className="inline-flex items-center gap-2 px-3 py-1.5 border-[0.5px] border-[var(--color-lj-ink)] rounded-full font-lj-mono text-[0.6875rem] leading-[1.5] lowercase text-[var(--color-lj-ink)] bg-transparent">
