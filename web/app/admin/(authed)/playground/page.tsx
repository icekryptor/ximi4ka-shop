...
export default function PlaygroundPage() {
  ...
  return (
    <div className="max-w-5xl">
      <h1 className="text-2xl font-bold text-brand-text mb-4">Песочница редактора</h1>
      <RichTextEditor value={html} onChange={setHtml} placeholder="Введите текст..." />
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2 text-brand-text">Предпросмотр</h2>
      <div
        className="bg-white border border-brand-border rounded-lg p-4 prose prose-sm max-w-none"
        dangerouslySetInnerHTML={{ __html: html }}
      />

      <h2 className="text-lg font-semibold mt-12 mb-2 text-brand-text">Редактор блоков</h2>
      <BlockEditor value={blocks} onChange={setBlocks} />
      <h3 className="text-md font-semibold mt-8 mb-2 text-brand-text">JSON состояние</h3>
