...
async function fetchPost(id: string): Promise<BlogPost | null> {
  ...
  const res = await fetch(`${ADMIN_API_URL_SERVER}/api/admin/blog/${encodeURIComponent(id)}`, {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-brand-text">Редактирование: {post.title}</h1>
