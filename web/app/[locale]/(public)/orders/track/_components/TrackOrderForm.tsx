    ...
    <section className="bg-[var(--color-lj-cream)] px-6 py-16 min-h-[70vh]">
      <div className="max-w-[var(--max-lj-narrow)] mx-auto">
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 max-w-md">
          ...
          <button
            type="submit"
            className="self-start inline-flex items-center gap-3 px-7 py-4 font-lj-mono text-[0.8125rem] font-medium uppercase tracking-[0.08em] rounded-full lj-cta-bright"
          >
            Найти заказ →
          </button>
        </form>
