    ...
    <LabSection variant="ink" className="px-6 py-32">
      ...
      <Container>
        <div className="flex flex-col items-center text-center gap-6 py-16">
          <h1
            className="font-display font-extrabold tracking-[var(--tracking-tight)] leading-none text-[length:var(--text-mega)] bg-clip-text text-transparent"
            style={{ backgroundImage: 'var(--gradient-accent)' }}
          >
            404
          </h1>
          <p className="text-[length:var(--text-h2)] font-display font-extrabold tracking-[var(--tracking-tight)] text-[var(--color-text-on-dark)]">
            Страница не найдена
          </p>
