...
> ⚠️ **Устарело (22.09.2026).** Railway-сервис api удалён («Application not
> found»), витрина на Vercel осталась без бэкенда. Переезжаем на свой VPS —
> актуальный ранбук: [`deploy/README.md`](deploy/README.md). Ниже — история
> первого деплоя; шаги про данные (импорты с Tilda) и смоук всё ещё актуальны.
